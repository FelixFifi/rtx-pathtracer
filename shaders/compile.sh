...
glslc --target-env=vulkan1.2 raytrace.irradiance.visualize.rint -O -o raytrace.irradiance.visualize.rint.spv
glslc --target-env=vulkan1.2 raytrace.irradiance.visualize.rchit -O -o raytrace.irradiance.visualize.rchit.spv
